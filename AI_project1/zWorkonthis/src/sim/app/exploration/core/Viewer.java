...
import sim.app.exploration.agents.SoloExplorerAgent;
...
public class Viewer extends GUIState{
	...
	public static String getName() { return "Collaborative Exploration: IA December 2020"; }
	...
	public void setupPortrayals(){
	    ...
	    Class objects[] = {Tree.class, Wall.class, SimObject.class, Bush.class, Water.class, House.class,Animal.class,Vehicle.class};
	    ...
	    knownWorld.setPortrayalForClass(
	        ExplorerAgent.class, new OrientedPortrayal2D(new SimplePortrayal2D(),0,4.0,
	                Color.orange,
	                OrientedPortrayal2D.SHAPE_COMPASS) );
	    
	    knownWorld.setPortrayalForClass(
	    		SoloExplorerAgent.class, new OrientedPortrayal2D(new SimplePortrayal2D(),0,4.0,
		                Color.red,
		                OrientedPortrayal2D.SHAPE_COMPASS) );
